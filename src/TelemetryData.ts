...
export function getRandomTelemetryData(): ITelemetryData {
  ...
  data.trackId = Math.floor(Math.random() * 100);
  return data;
}
export function packetToBuffer(packet: ITelemetryData): Buffer {
  return Buffer.from([
    packet.isRaceOn ? 1 : 0,
    packet.timeStampMS,
    packet.rpmData.current,
    packet.rpmData.max,
    packet.rpmData.idle,
    ...
    packet.velocity.y,
    packet.velocity.z,
    packet.angularVelocity.x,
    packet.angularVelocity.y,
    packet.angularVelocity.z,
    packet.yaw,
    packet.pitch,
    packet.roll,
    packet.normalizedSuspensionTravel.leftFront,
    packet.normalizedSuspensionTravel.leftRear,
    packet.normalizedSuspensionTravel.rightFront,
    packet.normalizedSuspensionTravel.rightRear,
    packet.tireSlipRatio.leftFront,
    packet.tireSlipRatio.leftRear,
    packet.tireSlipRatio.rightFront,
    packet.tireSlipRatio.rightRear,
    packet.wheelRotationSpeed.leftFront,
    packet.wheelRotationSpeed.leftRear,
    packet.wheelRotationSpeed.rightFront,
    packet.wheelRotationSpeed.rightRear,
    packet.wheelOnRumbleStrip.leftFront,
    packet.wheelOnRumbleStrip.leftRear,
    packet.wheelOnRumbleStrip.rightFront,
    packet.wheelOnRumbleStrip.rightRear,
    packet.wheelInPuddleDepth.leftFront,
    packet.wheelInPuddleDepth.leftRear,
    packet.wheelInPuddleDepth.rightFront,
    packet.wheelInPuddleDepth.rightRear,
    packet.surfaceRumble.leftFront,
    packet.surfaceRumble.leftRear,
    packet.surfaceRumble.rightFront,
    packet.surfaceRumble.rightRear,
    packet.tireSlipAngle.leftFront,
    packet.tireSlipAngle.leftRear,
    packet.tireSlipAngle.rightFront,
    packet.tireSlipAngle.rightRear,
    packet.tireCombinedSlip.leftFront,
    packet.tireCombinedSlip.leftRear,
    packet.tireCombinedSlip.rightFront,
    packet.tireCombinedSlip.rightRear,
    packet.suspensionTravelMeters.leftFront,
    packet.suspensionTravelMeters.leftRear,
    packet.suspensionTravelMeters.rightFront,
    packet.suspensionTravelMeters.rightRear,
    packet.carInfo.ordinalId,
    packet.carInfo.carType.length, // Assuming carType is a string, encode its length
    ...Buffer.from(packet.carInfo.carType, 'utf-8'), // Encode carType as UTF-8
    packet.carInfo.class,
    packet.carInfo.numberOfCylinders,
    packet.carInfo.performanceIndex,
    packet.carInfo.drivetrainType,
    packet.objectHit,
    packet.position.x,
    packet.position.y,
    packet.position.z,
    ...
    packet.power,
    packet.torque,
    packet.tireTemp.leftFront,
    packet.tireTemp.leftRear,
    packet.tireTemp.rightFront,
    packet.tireTemp.rightRear,
    packet.boost,
    packet.fuel,
    ...
    packet.gear,
    packet.steer,
    packet.normalizedDrivingLine,
    packet.normalizedAIBrakeDifference,
    packet.tireWear.leftFront,
    packet.tireWear.leftRear,
    packet.tireWear.rightFront,
    packet.tireWear.rightRear,
    packet.trackId
  ]);
}
